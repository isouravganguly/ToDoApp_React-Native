...
function Header({statusType}) {
  return (
    ...
    <View style={[styles.button, styles.shadow, styles.completed]}>
        <Pressable  onPress={()=>statusType(1)}><Text style={styles.buttonText}>Completed</Text></Pressable>
    </View>

    <View style={[styles.button, styles.shadow, styles.active]}>
        <Pressable  onPress={()=>statusType(2)}><Text style={styles.buttonText}>Active</Text></Pressable>
    </View>
